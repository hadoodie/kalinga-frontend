          ...
          <div className="grid grid-cols-4 gap-5 md:gap-3 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4">
            <div className="bg-[#163a14] rounded-lg min-h-[130px] flex items-center justify-center p-3">
              <div className="flex flex-row lg:items-center md:items-center sm:items-center lg:gap-4 md:gap-2 sm:gap-1">
                <Package size={90} color="#f0d003" className="lg:size-[90px] sm:size-[58px] md:size-[60px]"/>
                <div className="flex flex-col items-center">
                  <div className="lg:text-[30px] text-white font-bold sm:text-[20px] md:text-[25px]">{totalRemaining}</div>
                  <div className="lg:text-[15px] md:text-[13px] text-center sm:text text-white">Remaining Items</div>
                </div>
              </div>
            </div>
            <div className="bg-[#163a14] rounded-lg min-h-[130px] flex items-center justify-center p-3">
              <div className="flex flex-row lg:items-center md:items-center sm:items-center lg:gap-4 md:gap-2 sm:gap-1">
                <Truck size={90} color="#f0d003" className="lg:size-[90px] sm:size-[50px] md:size-[60px]"/>
                <div className="flex flex-col items-center">
                  <div className="lg:text-[30px] text-white font-bold sm:text-[20px] md:text-[25px]">{totalDistributed}</div>
                  <div className="lg:text-[15px] md:text-[13px] text-center sm:text text-white">Distributed Items</div>
                </div>
              </div>
            </div>
            <div className="bg-[#163a14] rounded-lg min-h-[130px] flex items-center justify-center p-3">
              <div className="flex flex-row lg:items-center md:items-center sm:items-center lg:gap-4 md:gap-2 sm:gap-1">
                <ArchiveRestore size={90} color="#f0d003" className="lg:size-[90px] sm:size-[50px] md:size-[60px]"/>
                <div className="flex flex-col items-center">
                  <div className="lg:text-[30px] text-white font-bold sm:text-[20px] md:text-[25px]">{totalReceived}</div>
                  <div className="lg:text-[15px] md:text-[13px] text-center sm:text text-white">Received Items</div>
                </div>
              </div>
            </div>
            <div className="bg-[#163a14] rounded-lg min-h-[130px] flex items-center justify-center p-3">
              <div className="flex flex-row lg:items-center md:items-center sm:items-center lg:gap-4 md:gap-2 sm:gap-1">
                <CircleAlert size={90} color="#f0d003" className="lg:size-[90px] sm:size-[50px] md:size-[60px]"/>
                <div className="flex flex-col items-center">
                  <div className="lg:text-[30px] text-white font-bold sm:text-[20px] md:text-[25px]">{criticalCount}</div>
                  <div className="lg:text-[15px] md:text-[13px] text-center sm:text-sm text-white">Critical Items</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="relative inline-block">
              ...
              >
                <div className="flex flex-row items-center justify-center gap-1">
                  {facility}
                  <ChevronDown size={20} className={`${open ? 'rotate-180' : 'rotate-0'} transition-transform duration-200`}/>
                </div>
              </button>
            ...
            <>
              ...
              >
                <div className="flex justify-between items-start">
                  <div className="text-lg font-extrabold text-[#1A4718]">{item.resource}</div>
                  <div
                    className={`py-1 px-3 text-xs font-bold rounded-full text-white ${
                      item.status === "Critical" ? "bg-red-600" :
                      item.status === "High" ? "bg-green-600" :
                      "bg-yellow-500"
                    }`}
                  >
                    {item.status}
                ...
                <div className="flex flex-col gap-y-1 text-sm text-gray-700">
                  <div className="flex justify-between border-b border-gray-100 pb-1"><span className="font-medium text-gray-500">Category:</span> <span>{item.category}</span></div>
                  <div className="flex justify-between border-b border-gray-100 pb-1"><span className="font-medium text-gray-500">Received:</span> <span className="text-green-700">{item.received}</span></div>
                  <div className="flex justify-between border-b border-gray-100 pb-1"><span className="font-medium text-gray-500">Distributed:</span> <span className="text-red-700">{item.distributed}</span></div>
                  <div className="flex justify-between"><span className="font-medium text-gray-500">Remaining:</span> <span className="font-bold">{item.remaining} {item.unit}</span></div>
                </div>
              </div>
            </>
          ))}
          ...
          {filteredInventory.length > 0 && (
            <>
              ...
              <div className="md:hidden flex flex-col gap-2 font-bold text-white bg-[#1A4718] p-4 text-sm rounded-lg mt-3 shadow-lg">
                <div className="text-lg mb-1 border-b border-[#3c6b39] pb-2">TOTAL INVENTORY SUMMARY</div>
                <div className="flex justify-between border-b border-[#3c6b39] pb-1"><span>Total Received:</span> <span>{totalReceived}</span></div>
                <div className="flex justify-between border-b border-[#3c6b39] pb-1"><span>Total Distributed:</span> <span>{totalDistributed}</span></div>
                <div className="flex justify-between"><span>Total Remaining:</span> <span>{totalRemaining}</span></div>
              </div>
            </>
          )}
        </div>
