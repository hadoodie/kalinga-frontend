...
const statusBadges = {
  ...
  Packed: "bg-purple-100 text-purple-700 dark:bg-purple-500/10 dark:text-purple-300",
  Shipped: "bg-sky-100 text-sky-700 dark:bg-sky-500/10 dark:text-sky-300",
  "On-the-Way": "bg-indigo-100 text-indigo-700 dark:bg-indigo-500/10 dark:text-indigo-300",
  ...
  Delayed: "bg-orange-100 text-orange-700 dark:bg-orange-500/10 dark:text-orange-300",
};
...
export const LogisticsOverview = () => {
  ...
  const currentData = activeTab === "incoming" ? incoming : activeTab === "outgoing" ? outgoing : tracking;
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <div className="flex items-center gap-4 rounded-2xl border border-border/60 bg-card/80 p-4">
          ...
          <div>
            <p className="text-2xl font-bold text-foreground">{stats?.inTransit ?? 0}</p>
              ...
              >
                <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                  ...
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="text-foreground/70">{shipment.contents}</span>
                  </div>
                  ...
                  <div className="text-right text-xs text-foreground/60">
                    <p>ETA: {shipment.eta ? new Date(shipment.eta).toLocaleString() : "TBD"}</p>
            ...
            <table className="min-w-full divide-y divide-border/60 text-sm">
              ...
              <tbody className="divide-y divide-border/60 bg-background/50">
                {currentData.slice(0, 10).map((request) => (
                  <tr key={request.id || request.request_id} className="hover:bg-primary/5 transition">
                    ...
                    <td className="px-4 py-3">
                      <div>
                        ...
                        <p className="text-xs text-foreground/60">Qty: {request.item_quantity}</p>
                      </div>
                    </td>
