...
export default function Settings() {
  ...
  const [devices, setDevices] = useState(
    loadData("devices", [
      { id: 1, name: "Chrome on Windows", location: "Manila, Philippines", lastActive: "2 hours ago" },
      { id: 2, name: "Safari on iPhone", location: "Quezon City, Philippines", lastActive: "Yesterday" },
    ])
  );
  ...
  const [contacts, setContacts] = useState(
    loadData("contacts", [
      { id: 1, name: "Maria Dela Cruz", relation: "Sister", phone: "0917-123-4567" },
      { id: 2, name: "Brgy. Tanod", relation: "Barangay Official", phone: "0918-222-3333" },
    ])
  );
  ...
  const [alerts, setAlerts] = useState(
    loadData("alerts", { types: [], sms: false, email: false, urgentOnly: false })
  );
  const [location, setLocation] = useState(
    loadData("location", { address: "", gps: false, evacuation: false })
  );
  const [household, setHousehold] = useState(
    loadData("household", { residents: 0, children: false, elderly: false, pwd: false, medical: "", pets: "" })
  );
  const [sharing, setSharing] = useState(
    loadData("sharing", { responders: false, community: false, retention: "Keep for 30 days" })
  );
  ...
  <div className="flex bg-background text-white h-auto overflow-hidden p-4 gap-x-2">
    ...
    <div className="h-full w-64 bg-white p-4 rounded-lg flex flex-col shadow-md">
      ...
      <div className="bg-white flex-1 rounded-lg p-6 overflow-y-auto shadow-md">
        {activeTab === "privacy" && (
          <div>
          <h1 className="text-2xl font-bold mb-3 text-primary text-left">Data & Privacy</h1>
            <div className="bg-background rounded-lg p-6 space-y-4">
              <div className="flex items-center justify-between bg-background text-primary">
                ...
                <input
                  ...
                  onChange={(e) => setSharing({ ...sharing, analytics: e.target.checked })}
                />
              </div>
              <div className="flex items-center justify-between bg-background text-primary">
                ...
                <input
                  ...
                  onChange={(e) => setSharing({ ...sharing, personalized: e.target.checked })}
                />
              </div>
              <div className="flex items-center justify-between bg-background text-primary">
                ...
                <input
                  ...
                  onChange={(e) => setSharing({ ...sharing, responders: e.target.checked })}
                />
              </div>
              <div className="flex items-center justify-between bg-background text-primary">
                ...
                <input
                  ...
                  onChange={(e) => setSharing({ ...sharing, community: e.target.checked })}
                />
              </div>
              <div className="flex items-center justify-between bg-background text-primary">
                ...
                <select
                  ...
                  onChange={(e) => setSharing({ ...sharing, retention: e.target.value })}
        ...
        {activeTab === "devices" && (
          <div>
            <h1 className="text-2xl font-bold mb-3 text-primary text-left">Devices</h1>
            <div className="bg-background rounded-lg space-y-4">
              {devices.length === 0 ? (
                ...
                <ul className="space-y-3">
                  {devices.map((d) => (
                    <li key={d.id} className="flex items-center text-left justify-between bg-background text-primary p-4 rounded">
                      <div>
                        <p className="font-medium">{d.name}</p>
                        <p className="text-sm text-gray-400">{d.location} • Last active {d.lastActive}</p>
                      </div>
        ...
        {activeTab === "alerts" && (
          <div>
            <h1 className="text-2xl font-bold mb-3 text-primary text-left">Alert Preferences</h1>
            <div className="bg-background rounded-lg p-6 space-y-4">
              <div>
                <p className="text-primary text-left">Alert Types</p>
                <div className="flex flex-wrap gap-2 mt-2">
                  {["Flood", "Fire", "Earthquake", "Medical", "Conflict"].map((type) => (
                    <label key={type} className="flex items-center gap-2 bg-primary px-3 py-2 rounded">
                      <input
                        type="checkbox"
              ...
              <div className="flex items-center justify-between bg-background text-primary ">
                ...
                <input
                  ...
                  onChange={(e) => setAlerts({ ...alerts, urgentOnly: e.target.checked })}
                />
              </div>
              <button
        ...
        {activeTab === "location" && (
          <div>
            <h1 className="text-2xl font-bold mb-3 text-primary text-left">Location Settings</h1>
            <div className="bg-background rounded-lg p-6 space-y-4">
              <div>
                <p className="text-primary text-left">Home Address / Barangay</p>
                <input
                  type="text"
              ...
              <div className="flex items-center justify-between bg-background text-primary">
                ...
                <input
                  ...
                  onChange={(e) => setLocation({ ...location, gps: e.target.checked })}
                />
              </div>
              <div className="flex items-center justify-between bg-background text-primary">
                ...
                <input
                  ...
                  onChange={(e) => setLocation({ ...location, evacuation: e.target.checked })}
                />
              </div>
              <button
        ...
        {activeTab === "contacts" && (
          <div>
            <h1 className="text-2xl font-bold mb-3 text-primary text-left">Emergency Contacts</h1>
            <div className="bg-background rounded-lg p-6 space-y-4 text-left">
              <ul className="space-y-3">
                {contacts.map((c) => (
                  <li key={c.id} className="flex items-center justify-between bg-background text-primary">
                    {editingContact === c.id ? (
                      <div className="flex flex-col gap-2 w-full">
                        <input
                          type="text"
                          value={c.name}
                          onChange={(e) => handleEditContact(c.id, "name", e.target.value)}
                          placeholder="Name"
                        ...
                        <input
                          type="text"
                          value={c.relation}
                          onChange={(e) => handleEditContact(c.id, "relation", e.target.value)}
                        ...
                        <input
                          type="text"
                          value={c.phone}
                          onChange={(e) => handleEditContact(c.id, "phone", e.target.value)}
                      ...
                      <>
                        ...
                        <div className="flex gap-2">
                          <button onClick={() => setEditingContact(c.id)} className="p-2 hover:text-indigo-400">
                            <Edit2 className="w-4 h-4" />
                          </button>
                          <button onClick={() => handleDeleteContact(c.id)} className="p-2 hover:text-red-400">
              ...
              <div className="flex gap-2">
                ...
                <input
                  ...
                  className="px-2 py-1 rounded bg-white text-primary"
                />
                <button onClick={handleAddContact} className="bg-primary px-4 py-2 rounded">
