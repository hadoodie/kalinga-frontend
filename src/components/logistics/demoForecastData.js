...
export const DEMO_HIGH_RISK_ITEMS = [
  {
    ...
    projected_stock: 3,
    risk_factors: {
      low_stock: "Stock at 8% of minimum",
      low_survival: "Only 14h survival",
    },
  },
  {
    hospital_id: 10,
    ...
    projected_stock: 1,
    risk_factors: {
      low_stock: "Stock at 5% of minimum",
  ...
  },
  {
    ...
    resource: {
      id: 5,
      name: "Normal Saline IV 1L",
      category: "pharmaceuticals",
    },
    risk_prob: 0.85,
    risk_level: "critical",
    days_until_stockout: 2.1,
    projected_stock: 45,
    risk_factors: { low_stock: "Stock at 12% of minimum" },
  },
  {
    hospital_id: 8,
    resource_id: 3,
    ...
    projected_stock: 8,
    risk_factors: {
      low_stock: "Stock at 22% of minimum",
      low_survival: "Only 38h survival",
    },
  },
  {
    hospital_id: 11,
    ...
    projected_stock: 5,
    risk_factors: { low_stock: "Stock at 18% of minimum" },
  },
  {
    hospital_id: 12,
    resource_id: 6,
    ...
    projected_stock: 30,
    risk_factors: { low_stock: "Stock at 25% of minimum" },
  },
  {
    hospital_id: 2,
    resource_id: 9,
    ...
    projected_stock: 12,
    risk_factors: { low_stock: "Stock at 30% of minimum" },
  },
  {
    hospital_id: 3,
    resource_id: 13,
    ...
    risk_prob: 0.66,
    risk_level: "high",
    days_until_stockout: 5.8,
    projected_stock: 50,
    risk_factors: { low_stock: "Stock at 32% of minimum" },
  },
];
  ...
  heatmapHospitals.forEach((h) => {
    heatmapResources.forEach((r) => {
      ...
      data.push({
        ...
        risk_factors:
          level !== "low"
            ? { low_stock: `Stock at ${Math.round(prob * 40)}% of minimum` }
            : {},
      });
    });
  });
