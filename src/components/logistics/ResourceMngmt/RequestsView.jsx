...
const Button = ({
  ...
  const base =
    "inline-flex items-center justify-center rounded-xl font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 disabled:pointer-events-none disabled:opacity-50 active:scale-95";
  ...
  const variants = {
    ...
    outline:
      "border-2 border-green-300 bg-white text-green-800 hover:bg-green-50 hover:border-green-400 hover:shadow-md",
    destructive:
...
const Badge = ({
  ...
  const variants = {
    ...
    success:
      "bg-gradient-to-r from-green-100 to-emerald-50 text-green-800 border-2 border-green-300",
    warning:
      "bg-gradient-to-r from-amber-100 to-yellow-50 text-amber-800 border-2 border-amber-300",
    info: "bg-gradient-to-r from-blue-100 to-blue-50 text-blue-800 border-2 border-blue-300",
    purple:
      "bg-gradient-to-r from-purple-100 to-purple-50 text-purple-800 border-2 border-purple-300",
  };
...
const InfoChip = ({ icon: Icon, label, value, color = "green" }) => {
  const colors = {
    green:
      "text-green-700 bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200",
    blue: "text-blue-700 bg-gradient-to-r from-blue-50 to-blue-50 border-2 border-blue-200",
    amber:
      "text-amber-700 bg-gradient-to-r from-amber-50 to-yellow-50 border-2 border-amber-200",
    purple:
      "text-purple-700 bg-gradient-to-r from-purple-50 to-purple-50 border-2 border-purple-200",
  ...
  return (
    <div
      className={`flex items-center gap-3 rounded-xl border-2 px-4 py-3 ${colors[color]}`}
    >
      ...
      <Card>
        <CardContent className="p-12 text-center">
          ...
          <p className="text-gray-600 mt-2">
            All deliveries have been confirmed
          </p>
        </CardContent>
      </Card>
    );
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                    ...
                    <InfoChip
                      ...
                      value={
                        delivery.allocation?.source_hospital ||
                        "General Hospital B"
                      }
                      color="purple"
                    />
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-amber-700 mt-1">
                          Please confirm delivery by verifying the items and
                          uploading Proof of Delivery (POD) within 24 hours.
                        </p>
                      </div>
                    </div>
                  </div>
...
const RequestsView = ({ facility, hospitalId }) => {
  ...
  const fetchRequests = useCallback(async () => {
    ...
    try {
      ...
      const normalised = realRequests.map((req) => ({
        ...req,
        resource_name:
          req.resource_name || req.resource?.name || "Unknown Resource",
  ...
  const filteredRequests = useMemo(() => {
    ...
    switch (activeTab) {
      ...
      case "in_transit":
        filtered = filtered.filter(
          (r) => r.status === "allocated" || r.status === "in_transit",
        );
        break;
                    ...
                    <div className="flex flex-col lg:flex-row gap-6">
                      ...
                      <div className="flex-1">
                        <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4 mb-6">
                          ...
                          <div className="flex flex-wrap gap-2">
                            <Badge
                              variant={getUrgencyColor(req.urgency_level)}
                              icon={Zap}
                            >
                              {req.urgency_level}
                            </Badge>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                  <div>
                                    ...
                                    <div className="font-semibold text-blue-900">
                                      {req.allocation.vehicle_plate} (
                                      {req.allocation.vehicle_type})
                                    </div>
                                  </div>
                                  <div>
                                    <div className="text-sm text-gray-600">
                      ...
                      <div className="lg:w-64 flex flex-col gap-3">
                        <Button
                          variant="outline"
                          onClick={async () => {
                            const details = await requestService.getById(
                              req.id,
                            );
      ...
      >
        <div>
          ...
          <p className="text-gray-700 mt-2">
            Manage and track your resource requests for{" "}
            ...
            <div className="flex justify-between items-center mt-4 pt-4 border-t border-green-200">
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  ...
                  Date
                  <ArrowUpDown
                    className={`h-3 w-3 ${sortBy === "created_at" ? "text-green-600" : "text-gray-400"}`}
                  />
                </Button>
                <Button
                  variant="ghost"
                ...
                >
                  ...
                  Urgency
                  <ArrowUpDown
                    className={`h-3 w-3 ${sortBy === "urgency" ? "text-green-600" : "text-gray-400"}`}
                  />
                </Button>
              </div>
            </div>
