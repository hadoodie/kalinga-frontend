// src/components/logistics/registry/ReportTemplates.jsx - FIXED
...
const ReportTemplates = ({ onTemplateSelect, onPreview, onSchedule }) => { // ADDED onSchedule prop
  ...
  const reportTemplates = [
    {
      ...
      supportsScheduling: true // ADDED SCHEDULING SUPPORT
    },
    {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <span>{reportTemplates.filter(t => t.supportsScheduling).length} schedulable</span>
          </div>
        </div>
      </div>
      ...
      {/* Templates Grid - UPDATED WITH SCHEDULING */}
        ...
        {filteredTemplates.map(template => {
          ...
          return (
            ...
            >
              ...
              {/* Actions - UPDATED WITH SCHEDULE BUTTON */}
              <div className="flex gap-2">
                ...
                {/* Conditionally show Schedule button */}
                {template.supportsScheduling ? (
                  <div className="flex gap-1">
                    ...
                    <button
                      ...
                      className="flex items-center justify-center px-3 py-2 text-sm text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition font-medium"
