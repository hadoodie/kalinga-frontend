...
export default function CreateAcc() {
  ...
  const isPasswordStrong = (pwd) => {
    ...
    const hasLetters = /[A-Za-z]/; // at least one letter
    const hasNumbers = /[0-9]/; // at least one number
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "Welcome to Kalinga!",
        className:
  ...
  return (
    <div className="min-h-screen bg-background px-4 sm:px-6 lg:px-8 flex items-center justify-center">
      {/* Container that stays vertically + horizontally centered */}
      <div className="w-full max-w-md bg-card shadow-lg rounded-xl p-6 sm:p-8">
