      ...
      <div className="online-training">
          ...
          <div className="career-cards">
            ...
            <div className="career-card">
              ...
              <div className="career-text">
                ...
                <p>
                  <strong>Train your government employees</strong>
                </p>
                <p>
            ...
            <div className="career-card">
              ...
              <div className="career-text">
                ...
                <p>
                  <strong>Train your citizens</strong>
                </p>
                <p>
                  Enable your workforce to develop job-relevant skills to help
                  reduce unemployment and increase economic competitiveness.
                </p>
                <a href="#">Learn More →</a>
              </div>
            </div>
        ...
        <section className="talent-section">
          <div className="talent-left">
            <h3>
              Grow your talent and economy with the world’s leading skills
              platform
            </h3>
            <p>
              Drive sustainable economic growth and build a competitive
          ...
          <div className="talent-right">
            <div className="talent-item">
              <span className="emoji">
                <FaUniversity size={28} color="#1E2A78" />
              </span>
              <div>
                <h4>World-Class Training</h4>
                <p>
                  Empower your learners with world-class training and
                  credentials from 350+ leading universities and companies.
                </p>
              </div>
            </div>
            ...
            <div className="talent-item">
              <span className="emoji">
                <FaLaptopCode size={28} color="#27ae60" />
              </span>
              <div>
            ...
            <div className="talent-item">
              <span className="emoji">
                <FaChalkboardTeacher size={28} color="#2980b9" />
              </span>
              <div>
                <h4>Hands-on Learning</h4>
                <p>Enable applied learning through assessments and projects.</p>
              </div>
            </div>

            <div className="talent-item">
              <span className="emoji">
                <FaChartLine size={28} color="#e67e22" />
              </span>
              <div>
